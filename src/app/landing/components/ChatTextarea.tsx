...
const ChatTextarea = () => {
    return (
        <div className="relative max-w-6xl sm:max-w-4xl mx-auto">
            <Textarea autoFocus placeholder="Tell me, are you feeling alright today?"
                className="placeholder:text-gray-700 text-gray-900 placeholder:italic placeholder:tracking-wide tracking-wide placeholder:text-sm placeholder:sm:text-base text-sm md:text-base bg-primary/10 border-2 border-primary sm:rounded-[45px] rounded-4xl px-5 py-3 sm:px-7 sm:py-5 min-h-36 outline-none focus-visible:ring-0 ring-0 resize-none
                overflow-hidden" />
